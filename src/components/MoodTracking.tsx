  ...
  if (!moodStats || moodStats.totalEntries === 0) {
    return (
      <div className="text-center py-12">
        <div className="text-6xl mb-4 opacity-20 font-light">Mood</div>
            ...
            <div className="flex items-center space-x-3">
              <div className="w-20 bg-gray-200 rounded-full h-2">
                <div 
                  ...
                  style={{ width: `${insights.positiveMoodPercentage}%` }}
                />
              </div>
            ...
            <div className="flex items-center space-x-3">
              <div className="w-20 bg-gray-200 rounded-full h-2">
                <div 
                  ...
                  style={{ width: `${insights.neutralMoodPercentage}%` }}
                />
              </div>
              <span className="text-sm font-semibold text-gray-900 w-8">{insights.neutralMoodPercentage}%</span>
            </div>
          </div>
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              <div className="w-20 bg-gray-200 rounded-full h-2">
                <div 
                  ...
                  style={{ width: `${insights.negativeMoodPercentage}%` }}
                />
              </div>
      ...
      <div>
        ...
        <div className="space-y-2">
          {recentMoods.slice(0, 5).map((entry, index) => (
            <div key={entry.journalId} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-200">
              ...
              <div className="flex gap-1">
                {entry.mood.slice(0, 2).map((mood, moodIndex) => (
                  <span
                    key={moodIndex}
                    className="px-2 py-1 rounded-md text-xs border border-gray-300 bg-white text-gray-700 font-medium"
                  >
                    {mood}
                  </span>
                ))}
