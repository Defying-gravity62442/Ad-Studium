  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-foreground disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-gray-200 bg-background shadow-sm hover:bg-gray-100 hover:text-foreground",
        secondary: "bg-gray-100 text-foreground shadow-sm hover:bg-gray-100/80",
        ghost: "hover:bg-gray-100 hover:text-foreground",
        link: "text-foreground underline-offset-4 hover:underline",
        danger: "bg-red-600 text-white shadow hover:bg-red-700",
        "danger-outline": "border border-red-600 text-red-600 bg-background shadow-sm hover:bg-red-600 hover:text-white",
      },
      size: {
